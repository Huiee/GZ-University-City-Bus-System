          ...
          <div class="col-lg-12">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <p>广州大学城公交线路查询——公交线路</p>
                <form action="/searchBusByNumber" name="busNumber" method="post">
                  <table>
                    <tr>
                      ...
                      <td style="padding: 20px 20px;"> <button type="button" class="btn btn-theme"onclick="return checkBusNumber()">查询</button></td>
                    </tr>
                  </table>
                  <br>
                </form>
          ...
          <div class="col-lg-12">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <p>${busMes.start_station!}--${busMes.end_station!} |首 ${busMes.start_time} 末${busMes.end_time} | ${busMes.length!}|价格${busMes.price!}元</p>
                <form>
                  <table>
                    <tr>
                    ...
                    <#list bus_one as bus>
                          <td style="width: 10px; padding: 2px 20px;">
                            ${bus.go_number!} ${bus.station_name!}
                            <#if bus.subway ??>
                              <#if bus.subway !="">
            ...
            <div class="col-lg-12">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="custom-box">
                  ...
                  <p>${busMes_two.start_station!}--${busMes_two.end_station!} |首 ${busMes_two.start_time} 末${busMes_two.end_time} | ${busMes_two.length!}|价格${busMes_two.price!}元</p>
                  <form>
                    <table>
                      <tr>
                        <#list bus_two as bus>
                        <td style="width: 10px; padding: 2px 20px;">
                          ${bus.back_number!} ${bus.station_name!}
                          <#if bus.subway ??>
                          <#if bus.subway !="">
                            <span class="badge-subway bg-theme">${bus.subway?substring(0,1)}号线</span>
                            <#if bus.subway?length gt 2>
