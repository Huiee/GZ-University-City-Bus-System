              ...
              <div class="col-md-4 profile-text">
                ...
                <form action="/updateUserName" method="post">
                  <table>
                    <tr>
                      <td>
                        <input  class="form-control form-control-inline input-medium default-date-picker" name="new_user_name" id="new_user_name" style="width: 150px;margin-right: 15px;display: none" size="16" type="text" placeholder="请输入新用户名">
                      </td>
                      <td>
                        <button  class="btn btn-theme02"   type="submit" id="updateName" style="display: none"><i class="fa fa-check"></i></button>
                </td>
                    </tr>
                  </table>
                </form>
                <p><button class="btn btn-theme" id="show_new_user_name" style="margin-top: 20px" onclick="return showUpadteName()"><i class="fa fa-envelope" ></i> 修改用户名</button></p>
              </div>
              <!-- /col-md-4 -->
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  <p> <img src="/../images/${user_picture!}" class="img-circle"></p>
                  <p>
                    <form action="/updateUserPicture" method="post">
                    <button  class="btn btn-theme" style="width: 120px;"  type="submit" ><i class="fa fa-check"></i><input type="file" name="new_user_picture"   style="width: 75px;float: left;" class="btn-picture" ></button>
                  </form>
                  </p>
                </div>
              </div>
...
<#-- 用户 -- end -->
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('#show_new_user_name').click(function(){
        $('#new_user_name').style.display="";
        $('#updateName').style.display="";
      });
